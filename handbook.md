...
The product owner should know the users of the system, the business (for example, Medicaid insurance or DMV services), policy constraints, and have a background in technology and software development so they can understand what the development team is doing in order to guide them in decision making and prioritizing development efforts.
