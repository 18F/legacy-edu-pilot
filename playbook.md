...
<p class="footnote" id="footnote-2">2. A user story typically reads in form of "as a [role], I need [this thing], so I can [accomplish this]." For example, "as a social worker, I need case notes to be cached on my phone, so that I can access case notes in areas without mobile phone service." [There are other forms](https://blog.crisp.se/2014/09/25/david-evans/as-a-i-want-so-that-considered-harmful), but this is the form used most broadly. The main thing is that it incorporates a who, a what, and a why. All technical work is done in the service of addressing a user story. <a href="#reference-2">↩︎</a></p>
